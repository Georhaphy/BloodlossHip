...
st.markdown("<h1 style='text-align: center; color: black ; font-size: 25px ;'>Predict blood loss from Hip arthroplasty surgery</h1>", unsafe_allow_html=True)
...
"""
ให้ท่านประเมิน ASA ของผู้ป่วย โดย
...
- ASA Class V หมายความว่าผู้ป่วยในระยะสุดท้ายที่มีโอกาสตายได้ภายใน 24 ชั่วโมง
ไม่ว่าจะได้รับการผ่าตัดหรือไม
"""
...
if st.button('ประเมินความเสี่ยง'):
    ...
    if array[0] == 0: 
           st.code(f"""ผู้ป่วยมีความเสี่ยงน้อยที่จะเสียเลือด ควรจองเลือดไม่เกิน 1 U ค่าความเชื่อมั่น {k[0][0]*100}%""")
    else:
           st.code(f"""ผู้ป่วยมีความเสี่ยงที่จะเสียเลือด ควรจองเเลือด 2 U ขึ้นไป ค่าความเชื่อมั่น {k[0][1]*100}%""")
